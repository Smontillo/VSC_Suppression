...
plt.savefig('./Fig_S11a.pdf', dpi = 500, bbox_inches='tight')
plt.close()
...
plt.savefig('./Fig_S11b.pdf', dpi = 500, bbox_inches='tight')
plt.close()
...
ax.legend(frameon = False, fontsize = 17, handlelength=1.5, title_fontsize = 15, labelspacing = 0.2)
plt.savefig('./Fig_S11c.pdf', dpi = 500, bbox_inches='tight')
plt.close()
